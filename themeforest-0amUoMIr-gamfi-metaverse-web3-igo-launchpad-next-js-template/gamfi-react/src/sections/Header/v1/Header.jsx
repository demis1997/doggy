          ...
          <div className="gamfi_menu_right_sect gamfi_v1_menu_right_sect">
            <div className="gamfi_menu_list">
              <ul>
                ...
                {data?.map((menu, i) => (
                  <li key={i}>
                    <a href={menu.url}>{menu.title} {menu.subMenus?.length > 0}</a>
            ...
            <div className="gamfi_menu_btns">
              ...
              <div className="wallet_btn">
                ...
                <div className="wallet_token_list"> 
                    <a href="#"> <img src={walletIcon1} alt="icon" /> DogeCoin </a>  
                    <a href="#"> <img src={walletIcon2} alt="icon" />  LDoge</a>  
                    <a href="#"> <img src={walletIcon3} alt="icon" />  ShibaCoin</a>  
                </div>
              </div>
              <Button
                href="# "
